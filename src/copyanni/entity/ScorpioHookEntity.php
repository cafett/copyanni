...
class ScorpioHookEntity extends ItemEntity
{
    ...
    public function onHitEntity(Entity $entity) {
        ...
        if ($entity instanceof Player and $owner instanceof Player) {
            $entity->teleport($owner->asVector3()->add(0, 1));
            //todo:正面0.3ブロックぐらい先にテレポートさせる
            //todo:サウンド
        }
    }
